...
const towerTypes = {
  Pistol: { cost: 10, range: 100, damage: 1 + wave, cooldown: 20 },
  Sniper: { cost: 20, range: 150, damage: 34 + wave, cooldown: 50 },
  Colonel: { cost: 40, range: 120, damage: 4 + wave, cooldown: 30 },
  Assault: { cost: 95, range: 130, damage: 3 + wave, cooldown: 17 },
  Destroyer: { cost: 220, range: 200, damage: 7 + wave, cooldown: 6 }
};
...
window.onload = function() {
  ...
  path = [
    createVector(0, 165), createVector(80, 165), createVector(80, 70), createVector(170, 70),
  ];
